...
public class UserValidation {
    ...
    public ResponseDTO validate(UserEntity user){
        ...
        if (user.getFirstName() == null ||
            ...
            response.setMessage("El campo firstName no puede ser nulo y debe poseer entre 3 y 15 caracteres");
        }
        ...
        if (user.getLastName() == null ||
            ...
            response.setNumOfErrors(response.getNumOfErrors() + 1);
            response.setMessage("El campo lastName no puede ser nulo y debe poseer entre 3 y 30 caracteres");
        }
